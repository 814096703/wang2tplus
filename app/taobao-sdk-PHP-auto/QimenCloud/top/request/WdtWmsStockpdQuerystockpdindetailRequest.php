<?php
/**
 * TOP API: 3ldsmu02o9.wdt.wms.stockpd.querystockpdindetail request
 * 
 * @author auto create
 * @since 1.0, 2020.08.27
 */
class WdtWmsStockpdQuerystockpdindetailRequest
{
	/** 
	 * 时间
	 **/
	...
	{
		return "3ldsmu02o9.wdt.wms.stockpd.querystockpdindetail";
	}
