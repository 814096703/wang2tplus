<?php
/**
 * TOP API: 3ldsmu02o9.wdt.sales.tradequery.querywithdetail request
 * 
 * @author auto create
 * @since 1.0, 2020.08.28
 */
class WdtSalesTradequeryQuerywithdetailRequest
{
	/** 
	 * 时间
	 **/
	...
	{
		return "3ldsmu02o9.wdt.sales.tradequery.querywithdetail";
	}
