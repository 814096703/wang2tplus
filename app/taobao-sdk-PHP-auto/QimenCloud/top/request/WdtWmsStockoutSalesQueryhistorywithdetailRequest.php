<?php
/**
 * TOP API: 3ldsmu02o9.wdt.wms.stockout.sales.queryhistorywithdetail request
 * 
 * @author auto create
 * @since 1.0, 2020.09.30
 */
class WdtWmsStockoutSalesQueryhistorywithdetailRequest
{
	/** 
	 * 时间
	 **/
	...
	{
		return "3ldsmu02o9.wdt.wms.stockout.sales.queryhistorywithdetail";
	}
