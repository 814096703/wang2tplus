<?php
/**
 * TOP API: 3ldsmu02o9.wdt.wms.stockout.purchasereturn.querywithdetail request
 * 
 * @author auto create
 * @since 1.0, 2020.09.18
 */
class WdtWmsStockoutPurchasereturnQuerywithdetailRequest
{
	/** 
	 * 时间
	 **/
	...
	{
		return "3ldsmu02o9.wdt.wms.stockout.purchasereturn.querywithdetail";
	}
