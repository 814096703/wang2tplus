<?php
/**
 * TOP API: 3ldsmu02o9.wdt.wms.stockpd.querystockpdoutdetail request
 * 
 * @author auto create
 * @since 1.0, 2020.08.31
 */
class WdtWmsStockpdQuerystockpdoutdetailRequest
{
	/** 
	 * 时间
	 **/
	...
	{
		return "3ldsmu02o9.wdt.wms.stockpd.querystockpdoutdetail";
	}
