<?php
/**
 * TOP API: 3ldsmu02o9.wdt.sales.tradequery.queryhistorywithdetail request
 * 
 * @author auto create
 * @since 1.0, 2020.09.29
 */
class WdtSalesTradequeryQueryhistorywithdetailRequest
{
	/** 
	 * 时间
	 **/
	...
	{
		return "3ldsmu02o9.wdt.sales.tradequery.queryhistorywithdetail";
	}
