<?php
/**
 * TOP API: 3ldsmu02o9.wdt.purchase.purchaseorder.querywithdetail request
 * 
 * @author auto create
 * @since 1.0, 2020.08.28
 */
class WdtPurchasePurchaseorderQuerywithdetailRequest
{
	/** 
	 * 时间
	 **/
	...
	{
		return "3ldsmu02o9.wdt.purchase.purchaseorder.querywithdetail";
	}
