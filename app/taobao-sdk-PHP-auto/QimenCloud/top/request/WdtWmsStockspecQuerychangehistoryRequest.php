<?php
/**
 * TOP API: 3ldsmu02o9.wdt.wms.stockspec.querychangehistory request
 * 
 * @author auto create
 * @since 1.0, 2020.08.25
 */
class WdtWmsStockspecQuerychangehistoryRequest
{
	/** 
	 * 时间
	 **/
	...
	{
		return "wdt.wms.stockspec.querychangehistory";
	}
