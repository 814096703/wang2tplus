<?php
/**
 * TOP API: 6vzhpmj261.wdt.aftersale.stockin.collect.query request
 * 
 * @author auto create
 * @since 1.0, 2020.10.15
 */
class WdtAftersaleStockinCollectQueryRequest
{
	/** 
	 * 结束时间
	 **/
	...
	{
		return "6vzhpmj261.wdt.aftersale.stockin.collect.query";
	}
