<?php
/**
 * TOP API: 6vzhpmj261.wdt.onsale.stockin.collect.query request
 * 
 * @author auto create
 * @since 1.0, 2020.10.15
 */
class WdtOnsaleStockinCollectQueryRequest
{
	/** 
	 * 结束时间
	 **/
	...
	{
		return "6vzhpmj261.wdt.onsale.stockin.collect.query";
	}
