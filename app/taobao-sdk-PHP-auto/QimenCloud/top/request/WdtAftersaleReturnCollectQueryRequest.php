<?php
/**
 * TOP API: 6vzhpmj261.wdt.aftersale.return.collect.query request
 * 
 * @author auto create
 * @since 1.0, 2020.10.15
 */
class WdtAftersaleReturnCollectQueryRequest
{
	/** 
	 * 结束时间
	 **/
	...
	{
		return "6vzhpmj261.wdt.aftersale.return.collect.query";
	}
