<?php
/**
 * TOP API: 3ldsmu02o9.wdt.purchase.purchaseorder.createorder request
 * 
 * @author auto create
 * @since 1.0, 2020.08.28
 */
class WdtPurchasePurchaseorderCreateorderRequest
{
	/** 
	 * 时间戳
	 **/
	...
	{
		return "3ldsmu02o9.wdt.purchase.purchaseorder.createorder";
	}
