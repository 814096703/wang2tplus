<?php
/**
 * TOP API: hu3cgwt0tc.wdt.ext.stockout.order.query.trade.yuemeng request
 * 
 * @author auto create
 * @since 1.0, 2020.09.08
 */
class WdtExtStockoutOrderQueryTradeYuemengRequest
{
	/** 
	 * app_rights
	 **/
	...
	{
		return "hu3cgwt0tc.wdt.ext.stockout.order.query.trade.yuemeng";
	}
