<?php
/**
 * TOP API: 3ldsmu02o9.wdt.aftersales.refund.refund.searchhistory request
 * 
 * @author auto create
 * @since 1.0, 2020.09.29
 */
class WdtAftersalesRefundRefundSearchhistoryRequest
{
	/** 
	 * s时间
	 **/
	...
	{
		return "3ldsmu02o9.wdt.aftersales.refund.refund.searchhistory";
	}
