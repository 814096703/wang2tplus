<?php
/**
 * TOP API: 3ldsmu02o9.wdt.purchase.purchasereturn.querywithdetail request
 * 
 * @author auto create
 * @since 1.0, 2020.09.04
 */
class WdtPurchasePurchasereturnQuerywithdetailRequest
{
	/** 
	 * 时间
	 **/
	...
	{
		return "3ldsmu02o9.wdt.purchase.purchasereturn.querywithdetail";
	}
