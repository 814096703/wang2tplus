...
require_once('./QimenCloud/Top/request/WdtWmsStockinOtherCreateotherstockinorderRequest.php');
...
$request = new WdtWmsStockinOtherCreateotherstockinorderRequest();
...
$request->setStockinOrder(json_encode($order));
